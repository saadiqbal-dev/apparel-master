...
export default function LatestNews() {
  return (
    <div className="max-w-screen overflow-hidden">
      <Carousel
        className="bg-dark pt-[103px] pb-[109px] w-full pl-[100px] relative"
        opts={{
          loop: true,
          align: "start",
        }}
      >
        <div className="bg-brand max-w-[586px] w-full h-[651px] rounded-[12px] relative flex flex-col justify-between py-[80px] px-[53px]">
  ...
  return (
    ...
    >
      ...
      <div className="px-7 pt-4.5 pb-5 h-full max-h-[246px] flex flex-col">
        <p className="text-meta font-inter text-sm font-medium leading-7">
          Awards
        </p>
        ...
        <p className="text-meta font-inter text-sm font-medium leading-7 mt-auto">
          Read more
        </p>
      </div>
    </Link>
