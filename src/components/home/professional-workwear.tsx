  ...
  return (
    <div className="px-5 pb-15 pt-10 xl:px-0 xl:pl-55 xl:pr-25 xl:pb-28.5 gap-10 xl:gap-23.5 flex flex-col-reverse xl:flex-row items-center justify-center">
      <img
        ...
        className="w-[353px] h-64 xl:max-w-215 xl:min-w-0 xl:h-auto xl:aspect-860/626 object-cover rounded-2xl xl:flex-1 xl:basis-0"
      />
      <div className="flex items-start justify-center dark flex-col max-w-161.75 min-w-0 xl:flex-1 xl:basis-0">
        ...
        <h2 className="max-w-[531px] text-black font-inter text-[28px] leading-[34px] xl:text-[48px] xl:leading-normal mb-8 xl:mb-12.5">
          Professional Workwear, Made Easy.
        </h2>
        <p className="font-inter text-lg leading-[26px] xl:text-xl xl:leading-normal text-black font-normal xl:font-medium mb-10 xl:mb-15">
